...
function createPlayers() {
  Player.find({}).remove(function() {
    Player.create(
      ...
      {name: 'Tony Romo ', age: 30, team: 'DAL', bye: '4', position: 'QB', qty: '1', projPts: '268', paTD: '29', ruTD: '1', reTD: '0', paYds: '4770', ruYds: '250', reYds: '0', selected: false, imageFile: 'qb_tonyRomo.png' },
